...
class ComparabilityReasonCode(StrEnum):
    ...
    ZERO_VELOCITY_REFERENCE_MISMATCH = "ZERO_VELOCITY_REFERENCE_MISMATCH"
    PHASE_SYSTEM_MISMATCH = "PHASE_SYSTEM_MISMATCH"
    PHASE_DEFINITION_MISMATCH = "PHASE_DEFINITION_MISMATCH"
    PHASE_BOUNDARY_METHOD_MISMATCH = "PHASE_BOUNDARY_METHOD_MISMATCH"
    PHASE_BOUNDARY_CONVENTION_MISMATCH = "PHASE_BOUNDARY_CONVENTION_MISMATCH"
    PHASE_METRIC_METHOD_MISMATCH = "PHASE_METRIC_METHOD_MISMATCH"
    SESSION_SELECTION_RULE_MISMATCH = "SESSION_SELECTION_RULE_MISMATCH"
    SESSION_RANKING_METRIC_MISMATCH = "SESSION_RANKING_METRIC_MISMATCH"
    SESSION_RANKING_METHOD_MISMATCH = "SESSION_RANKING_METHOD_MISMATCH"
    SESSION_RANKING_DIRECTION_MISMATCH = "SESSION_RANKING_DIRECTION_MISMATCH"
    SESSION_TIE_POLICY_MISMATCH = "SESSION_TIE_POLICY_MISMATCH"
    SESSION_AGGREGATION_RULE_MISMATCH = "SESSION_AGGREGATION_RULE_MISMATCH"
    SESSION_CANDIDATE_COUNT_MISMATCH = "SESSION_CANDIDATE_COUNT_MISMATCH"
    SESSION_ELIGIBLE_COUNT_MISMATCH = "SESSION_ELIGIBLE_COUNT_MISMATCH"
    SESSION_SELECTED_COUNT_MISMATCH = "SESSION_SELECTED_COUNT_MISMATCH"
    SESSION_CONTRIBUTING_COUNT_MISMATCH = "SESSION_CONTRIBUTING_COUNT_MISMATCH"
    MODALITY_MISMATCH = "MODALITY_MISMATCH"
    VALUE_ORIGIN_MISMATCH = "VALUE_ORIGIN_MISMATCH"
    SYSTEM_IDENTITY_MISMATCH = "SYSTEM_IDENTITY_MISMATCH"
    PROVIDER_MISMATCH = "PROVIDER_MISMATCH"
    MODEL_MISMATCH = "MODEL_MISMATCH"
    THRESHOLD_VALUE_MISMATCH = "THRESHOLD_VALUE_MISMATCH"
    THRESHOLD_UNIT_MISMATCH = "THRESHOLD_UNIT_MISMATCH"
    THRESHOLD_BASIS_MISMATCH = "THRESHOLD_BASIS_MISMATCH"
    THRESHOLD_BOUNDARY_MISMATCH = "THRESHOLD_BOUNDARY_MISMATCH"
    INDIVIDUALIZED_REFERENCE_MISMATCH = "INDIVIDUALIZED_REFERENCE_MISMATCH"
    DWELL_RULE_MISMATCH = "DWELL_RULE_MISMATCH"
    HYSTERESIS_MISMATCH = "HYSTERESIS_MISMATCH"
    GAP_ALLOWANCE_MISMATCH = "GAP_ALLOWANCE_MISMATCH"
    EVENT_START_RULE_MISMATCH = "EVENT_START_RULE_MISMATCH"
    EVENT_END_RULE_MISMATCH = "EVENT_END_RULE_MISMATCH"
    ACCELERATION_THRESHOLD_MISMATCH = "ACCELERATION_THRESHOLD_MISMATCH"
    DECELERATION_THRESHOLD_MISMATCH = "DECELERATION_THRESHOLD_MISMATCH"
    SESSION_DEFINITION_MISMATCH = "SESSION_DEFINITION_MISMATCH"
    INTERVAL_WINDOW_MISMATCH = "INTERVAL_WINDOW_MISMATCH"
    EXPOSURE_CONTEXT_MISMATCH = "EXPOSURE_CONTEXT_MISMATCH"
    AGGREGATION_SCOPE_MISMATCH = "AGGREGATION_SCOPE_MISMATCH"
    FILTERING_MISMATCH = "FILTERING_MISMATCH"
    SMOOTHING_MISMATCH = "SMOOTHING_MISMATCH"
    RESAMPLING_MISMATCH = "RESAMPLING_MISMATCH"
    DIFFERENTIATION_MISMATCH = "DIFFERENTIATION_MISMATCH"
    UNKNOWN_THRESHOLD = "UNKNOWN_THRESHOLD"
    UNKNOWN_THRESHOLD_BASIS = "UNKNOWN_THRESHOLD_BASIS"
    UNKNOWN_DWELL_RULE = "UNKNOWN_DWELL_RULE"
    UNKNOWN_EVENT_DEFINITION = "UNKNOWN_EVENT_DEFINITION"
    UNKNOWN_FILTERING = "UNKNOWN_FILTERING"
    UNKNOWN_SAMPLING_RATE = "UNKNOWN_SAMPLING_RATE"
    UNKNOWN_PROVIDER_ALGORITHM = "UNKNOWN_PROVIDER_ALGORITHM"
    UNKNOWN_SESSION_SEGMENTATION = "UNKNOWN_SESSION_SEGMENTATION"
    PROVIDER_ALGORITHM_MISMATCH = "PROVIDER_ALGORITHM_MISMATCH"
    NORMALIZATION_MISMATCH = "NORMALIZATION_MISMATCH"
    METRIC_DEFINITION_MISMATCH = "METRIC_DEFINITION_MISMATCH"
    METRIC_FAMILY_MISMATCH = "METRIC_FAMILY_MISMATCH"
    SESSION_SEGMENTATION_MISMATCH = "SESSION_SEGMENTATION_MISMATCH"
    UNKNOWN_METRIC_DEFINITION = "UNKNOWN_METRIC_DEFINITION"
    INTERPOLATION_MISMATCH = "INTERPOLATION_MISMATCH"
    UNKNOWN_INTERPOLATION = "UNKNOWN_INTERPOLATION"
    UNKNOWN_SMOOTHING = "UNKNOWN_SMOOTHING"
